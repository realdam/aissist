...
## Purpose
Enable users to add optional detailed descriptions to their goals, providing additional context beyond the goal title while maintaining backward compatibility with existing goals.
